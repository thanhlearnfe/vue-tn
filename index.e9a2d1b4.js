...
i = (function () {
  ...
  function m(t, e, o, s) {
    return { by: t, depends: e, key: o, split: s };
  }
  function d(t) {
  ...
  var D = m("lines", [M], "line", function (t, e, o) {
      return A(t, { matching: o[M] }, "offsetTop");
    }),
...
class l {
  ...
  fx5() {
    ...
    this.clearCells();
    const e = (o, s, i = 0) => {
      (s.cache = { state: s.state, color: s.color }),
        29 === i
  ...
  fx6() {
    let t = 0;
    const o = (s, i, n = 0) => {
      (i.cache = { state: i.state, color: i.color }),
        14 === n
          ? (i.set(i.original),
  ...
  constructor(e) {
    o(this, "DOM", { el: null }),
      ...
      o(this, "totalChars", 0),
      (this.DOM.el = e);
    const s = t(i)({ target: this.DOM.el, by: "lines" });
    s.forEach((e) => t(i)({ target: e.words }));
...
((s = "biu0hfr"),
new Promise((t) => {
  WebFont.load({ typekit: { id: s }, active: t });
})).then(() => {
